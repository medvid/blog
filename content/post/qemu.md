...
* Uninstall unneeded packages
        ...
        cave uninstall dev-util/pkg-config emacs gnutls glib-networking gnupg iproute2 tcl expect dejagnu --uninstalls-may-break '*/*' --purge '*/*' 
...
* [TBD] Compile static linux kernel images for all architectures and place near the exherbo.img
...
* [TBD] Install runit, make sure /sbin/init points to runit-init and setup runit configuration from https://github.com/medvid/runit-config

* [TBD] Enable extra targets per https://exherbo.org/docs/multiarch/multiarch-new-target.html

* [TBD] Switch qemu image to use QCOW2 format

* [TBD] Create snapshot of base qemu image

* [TBD] Create multiple derived images with /usr/host symlink pointing to different supported host architectures

* [TBD] Rebuild packages in the native virtualized environments
